// pipelines/pipeline-generator.ts
var PIPELINE_SCHEMA_REFERENCE = `## Pipeline Configuration Schema Reference
...
var config = {
  pipeline: {
    ...
    version: "1.0.0",
    description: "Meta-pipeline that generates new pipeline configurations from natural language descriptions",
  ...
  stages: [
    {
      ...
      type: "analyze",
      description: "Parse the user's description to understand pipeline requirements, goals, and constraints",
      model: {
        providerID: "anthropic",
        modelID: "claude-sonnet-4-5-20250929",
        tier: "medium",
...
Respond with ONLY this JSON object (no other text):
{
  ...
  "notes": "any additional considerations or recommendations"
    ...
    },
    {
      ...
      type: "structure",
      description: "Design the detailed pipeline architecture including data flow between stages",
      model: {
        providerID: "anthropic",
        modelID: "claude-sonnet-4-5-20250929",
        tier: "medium",
...
Respond with ONLY this JSON object (no other text):
{
  ...
  "settings": {
    ...
    },
    {
      ...
      type: "custom",
      description: "Generate the complete, valid PipelineConfig TypeScript code",
      model: {
        providerID: "anthropic",
        modelID: "claude-sonnet-4-5-20250929",
        tier: "medium",
...
{"pipelineConfig":{"pipeline":{...},"stages":[...]},"generationNotes":"..."}`,
    ...
    },
    {
      ...
      type: "validate",
      description: "Validate the generated pipeline configuration for correctness and completeness",
      model: {
        providerID: "anthropic",
...
Respond with ONLY this JSON object (no other text):
{
  ...
  "readyForUse": true
    ...
    },
    {
      ...
      type: "iterate",
      description: "Fix any issues found during validation and apply improvements",
      model: {
        providerID: "anthropic",
        modelID: "claude-sonnet-4-5-20250929",
        tier: "medium",
...
Respond with ONLY this JSON object (no other text):
{
  ...
  "remainingConcerns": []
    ...
    },
    {
      ...
      type: "custom",
      description: "Create the final pipeline output with usage instructions",
      model: {
        providerID: "anthropic",
        modelID: "claude-haiku-4-5-20251001",
        tier: "small",
...
var pipeline_generator_default = config;
export {
  pipeline_generator_default as default
};
